...
> **⚠️ OBJETIVO ACTUAL = `I-17` (BD de dos niveles: ideas maduras vs. incubación por umbral).** `P-14` quedó **DONE local el 2026-07-22**: los roles admin y visor pueden consultar rúbricas y prompts sin mutarlos. `I-17` sigue **BLOCKED por decisión**: antes de escribir código, confirmar con el usuario los puntos de su §5 y si el cierre por inactividad de ~5 minutos entra en este ítem o va aparte. Spec: `Iniciativas/I-17_BD_Dos_Niveles_Madurez.md`.
>
...
| **15b** | **`I-17` BD de dos niveles (maduro/incubación)** | **Sprint 1b–2** | **← ACTUAL: Claude, tras confirmación** | **BLOCKED-por-decisión** — antes de codificar, confirmar con el usuario los puntos I-17 §5 (¿umbral único o dos?, default 60/80, "guardar salvo no") y si el cierre por inactividad ~5 min entra en I-17 §7 o va aparte. Reutiliza el patrón de umbral por campaña de P-13. |
...
1. Identifica la iniciativa objetivo: **`I-17` BD de dos niveles** — Sprint 1b–2, **BLOCKED por decisión de diseño**. Antes de planear o editar, lee `Iniciativas/I-17_BD_Dos_Niveles_Madurez.md §5` y **confirma con el usuario**: (a) si el umbral de madurez es el mismo `UmbralCierreAnticipado` (I-01/P-13) o un `UmbralMadurez` independiente, (b) default 60 % u 80 %, (c) semántica de "guardar salvo que el usuario diga no", y (d) si el cierre por inactividad ~5 min entra en I-17 §7 o va aparte. `P-14` está DONE local (2026-07-22); `I-10` quedó DIFERIDA con I-09 por la reunión del 20-jul y NO es objetivo.
