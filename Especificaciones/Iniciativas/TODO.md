...
> **ESTADO VIGENTE 2026-07-23 — `ID-INICIATIVA=I-14`, BLOCKED:** I-17 está completa localmente. I-14 es datos/configuración y el CRUD de etiquetas más la carga masiva ya existen; falta que GHT entregue el catálogo consolidado (nombre, tipo, descripción opcional y estado). **No crear, inferir ni hardcodear etiquetas**. `I-12` sigue bloqueada por seeds e `I-13` espera la decisión GHT del 25-jul. Este bloque prevalece sobre referencias históricas inferiores a I-17 como próximo objetivo.
...
1. **`I-14` segmentación por tags está BLOCKED por un insumo externo.** El CRUD de etiquetas y la carga masiva I-08 ya existen; falta que GHT entregue el **catálogo consolidado** con nombre, tipo, descripción opcional y estado de cada etiqueta. No crear, inferir ni hardcodear etiquetas mientras falte ese insumo. `I-12` sigue bloqueada por seeds e `I-13` espera decisión GHT. Al recibir el catálogo, confirmar con el usuario cualquier decisión de diseño que exceda esos datos y ejecutar la configuración/validación correspondiente. Alternativas operativas independientes: commitear/push de I-17 o ejecutar en staging el runbook I-01/D5.
