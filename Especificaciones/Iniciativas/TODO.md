...
**Vas a implementar la iniciativa objetivo de este TODO: `ID-INICIATIVA=I-03` (follow-ups sobre eje débil). AGENTE ASIGNADO: `Codex`. VENTANA: Sprint 1b.** No es un desarrollo desde cero: continúas un MVP vivo. **Contexto ya HECHO y verificado:** P-03, P-10, D5 (baseline real pendiente), I-16, I-08 backend **e I-08 UI (2026-07-20, Claude Sonnet 5)**, I-06 diseño+implementación local, I-09 diseño **e I-09 core**, e **I-05 parafraseo DONE local (2026-07-20, Codex)**: `configConversacional.parafraseo` default `false` + kill-switch `Conversacion:Parafraseo`, salida/persistencia opcional y truncado por frase; D5 real contra staging pendiente. I-01 queda BLOCKED para activación real. **Tu objetivo ahora es I-03:** lee su spec y el índice; toca prompts → D5 es árbitro de no-regresión; confirma con el usuario cualquier decisión de diseño antes de codificar. Al terminar, rota este TODO al siguiente ítem según §4 y actualiza siempre cabecera, tabla, §8 y AVANCES.md.
...
| 13 | `I-03` follow-ups eje débil | Sprint 1b | Codex | **← ACTUAL (objetivo de este TODO)** — DESBLOQUEADA 2026-07-20 (rúbrica I-11 congelada 18-jul; D5 árbitro, baseline real pendiente) |
...
1. Identifica la iniciativa objetivo: **`I-03` follow-ups sobre eje débil** — agente **Codex**, Sprint 1b. Desbloqueada 2026-07-20 (rúbrica I-11 congelada 18-jul); leer `AVANCES.md`, `00_Indice_y_Plan_de_Ejecucion.md` (§2/§3) y `Iniciativas/I-03_*.md`. Toca prompts de evaluación → **D5 es árbitro de no-regresión** (baseline real contra staging sigue pendiente, no bloquea el diseño/implementación local con flags off). **I-08 carga masiva queda DONE (backend + UI) 2026-07-20.** Si la spec plantea una decisión de diseño (opción A/B/C), confírmala con el usuario antes de codificar, y rota el handoff al siguiente ítem ejecutable al cerrar.
