...
> **ESTADO VIGENTE 2026-07-25 — `I-18` coaching secuencial por idea ESPECIFICADO; implementación TODO.** La spec define prompt socrático + cola server-side por idea, revisiones enlazadas, umbral efectivo, salidas/límites/tiempo/fallback, contratos aditivos, observabilidad y rollback. Banderas nuevas apagadas por campaña; sin código ni activación en este corte documental. **PRÓXIMO OBJETIVO = implementar I-18 (fila 27, agente Claude)** en cortes pequeños, preservando el flujo legacy cuando el gate esté OFF. I-12/I-13/I-14 mantienen sus bloqueos externos.
...
| 27 | **`I-18` coaching secuencial por idea** | Sprint 2 | **Claude** | **SPEC DONE 2026-07-25 / implementación TODO.** Requiere I-06+I-03+I-17+P-15; cola y contador por idea, revisiones enlazadas, prompt socrático, timeout/fallback acotados, DTOs/Markdown/telemetría aditivos y flags OFF. D5/UAT/costo antes de activar. |
...
1. **Implementar `I-18` (fila 27, agente Claude).** Leer
   `I-18_Coaching_Secuencial_Por_Idea.md` y empezar por dominio/contratos + política pura de cola,
   con flags apagados y regresión del flujo legacy. No activar campañas. Los trabajos I-12/I-13/I-14
   siguen esperando sus insumos externos; no crear, inferir ni hardcodear etiquetas.
