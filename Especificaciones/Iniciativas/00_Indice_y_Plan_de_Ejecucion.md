...
| **P-34** | [P-34_Resultados_Filtros_Tabla_y_Exportacion.md](P-34_Resultados_Filtros_Tabla_y_Exportacion.md) | **EN CURSO — 1/6 (corte 1 DONE local 2026-08-20)** | Corte 1 (solo portal, sin contratos): páginas recorridas hasta el `total` del servidor en usuarios/Markdown/respuestas/conversaciones, contadores tomados de `total` con aviso de desglose parcial, y fallo del maestro de participantes visible/reintentable con «Participante no identificado · código». Portal 76 pruebas en 10 archivos; backend sin cambios. **Siguiente: corte 2** (escala a 1.000 ideas con medición de RU/latencia); después identidad/filtros server-side, tabla/metadata, exportación y resumen. Prioridad alta previa a convención. |
