...
> Última revisión: 2026-07-25 — **`P-22` UX de Campañas DONE local** (frontend 21/21, Prettier y build de producción verdes): creación bajo demanda, pasos de preparación con completitud accesible, enlace a Envíos con id real, configuración agrupada y estados vacíos guiados. **Siguiente: `P-23` UX de Resultados**. Ambas son frontend-only, sin cambio de contratos y construyen sobre P-16/P-18/P-19/P-20. Revisión anterior 2026-07-25 — **`P-21` multi-número de WhatsApp DONE local** (backend 473/473): dos números bajo la misma WABA/App, alias saliente por campaña y respuesta siempre por el número entrante, con fallback legacy seguro. Revisión anterior 2026-07-24 — **remediación de auditoría P-15 a P-20 incorporada; P-15 es el próximo ejecutable.** Revisión anterior 2026-07-21 (tarde) — **RE-PRIORIZACIÓN reunión GHT 20-jul** (grabación Fathom
