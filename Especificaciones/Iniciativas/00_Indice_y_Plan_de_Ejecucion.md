...
| **DT-RUB-01** | [DT-RUB-01_Rubrica_Estructurada_y_Evaluacion_Determinista.md](DT-RUB-01_Rubrica_Estructurada_y_Evaluacion_Determinista.md) | **corte 0 DONE; 0/4 de código** | Estructura versionada como fuente única, Markdown derivado, salida exacta por criterio, total ponderado server-side, eje débil/antifuga/snapshots coherentes y portal sin `Impacto` hardcodeado. Contratos `03`/`04`/`07`/`08`/`11` ya actualizados (corte documental 0). QAS `24_*`. |
