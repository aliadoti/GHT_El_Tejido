...
| P-13 | [P-13_Umbral_Cierre_Por_Campania.md](P-13_Umbral_Cierre_Por_Campania.md)                                                                                                                                                                             | **Sprint 1b (adelantada 2026-07-20)** | **← ACTUAL** (agente Claude; decisión de diseño confirmada 2026-07-21: override `configConversacional.umbralCierreAnticipado`, default numérico heredable y kill-switch booleano global `Conversacion:CierreAnticipadoHabilitado`; implementación pendiente) |
