...
> Última revisión: 2026-07-25 — **`P-21` multi-número de WhatsApp DONE local** (backend 473/473): dos números bajo la misma WABA/App, alias saliente por campaña y respuesta siempre por el número entrante, con fallback legacy seguro. **Siguiente: `P-22` UX de Campañas**; `P-23` UX de Resultados queda después. Ambas son frontend-only, sin cambio de contratos y construyen sobre P-16/P-18/P-19/P-20. Revisión anterior 2026-07-24 — **remediación de auditoría P-15 a P-20 incorporada; P-15 es el próximo ejecutable.** Revisión anterior 2026-07-21 (tarde) — **RE-PRIORIZACIÓN reunión GHT 20-jul** (grabación Fathom
...
| P-22 | [P-22_UX_Campanias.md](P-22_UX_Campanias.md) | A coordinar (mejoras de portal) | **TODO — spec lista 2026-07-25, implementación pendiente.** UX de Campañas (**frontend-only, sin contratos**): navegación guiada por ciclo de vida (pasos numerados con completitud), "Nueva campaña" como acción, enlace contextual a Envíos, formularios en fieldsets con instrucciones y espaciado, estados vacíos. Sobre P-16/P-18/P-19/P-20. |
| P-23 | [P-23_UX_Resultados.md](P-23_UX_Resultados.md) | A coordinar (mejoras de portal) | **TODO — spec lista 2026-07-25, implementación pendiente.** UX de Resultados (**frontend-only, sin contratos**): selección de campaña sin fricción, patrón **maestro-detalle** (lista de respuestas → evaluación + Markdown), leyenda de badges y conteos, lectura fácil y estados vacíos. Sobre I-17/P-18/P-19. |
...
| P-21 número saliente de WhatsApp | `configConversacional.numeroWhatsAppSaliente` (alias `string?`, default null) — **spec lista, TODO** | **null = usa el número predeterminado global** (`WhatsApp:AliasPredeterminado`); la respuesta conversacional NO usa este campo: sale siempre por el número entrante |
