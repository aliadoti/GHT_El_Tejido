...
> **Última revisión: 2026-08-20 — hotfix determinista DT-P33-01 desplegado.** `85b78f8`, tag
...
> integración, build/formato/diff verdes. Siguiente: terminar el fix completo y ejecutar la validación
> integral QAS/25 abierto/cerrado/mixto + D5 + acta.
>
...
| **DT-P33-01** | [DT-P33-01_Clasificacion_Semantica_Consulta_Idea.md](DT-P33-01_Clasificacion_Semantica_Consulta_Idea.md) | **HOTFIX DESPLEGADO; VALIDACIÓN INTEGRAL PENDIENTE — 2026-08-20** | `85b78f8` / `v1.0.3-convencion`, workflow/readiness verdes, gates ON e inglés v3 activo. Afinidad P-33 + `frases.confirmar` exacta prevalecen sin LLM/tokens; mixto/fallback = aporte. Gate local: 1053 unitarias + 121 integración. Siguiente: cierre del fix completo con QAS/25, D5 y acta. |
