...
| `Conversacion:FrasesFinalizarIdea` | App config / env `Conversacion__FrasesFinalizarIdea__0`, `...__1` | (lista compilada) | **P-27 / DT-P27-01 corte 1 implementado** — alias con los que el participante pide terminar la idea actual. Una lista configurada reemplaza el default; ausente/vacía usa la lista compilada vigente. Validación avanzada e historial quedan para corte 2. |
| `Conversacion:FrasesFinalizarParticipacion` | App config / env `Conversacion__FrasesFinalizarParticipacion__0`, `...__1` | (lista compilada) | **P-27 / DT-P27-01 corte 1 implementado** — alias con los que el participante pide terminar su participación. Una lista configurada reemplaza el default; ausente/vacía usa la lista compilada vigente. Validación avanzada e historial quedan para corte 2. |
