...
> verde con 734 pruebas (658 unitarias + 76 de integración), build Release y regresión focalizada.
> Leer primero `Especificaciones/AVANCES.md` y `Especificaciones/Iniciativas/TODO.md`: **`DT-QA-01`
> está DONE local (2026-08-05)**. El endpoint de diagnóstico
