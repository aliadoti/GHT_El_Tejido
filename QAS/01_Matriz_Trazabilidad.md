...
| **DT-P32-02 semillas/JSON/readiness** (P-32; 03 §3.13.1; 04 §5.7.1) | Base `es/en` independiente de legacy; descarga/prevalidación/importación masiva siempre a borrador; límites, permisos, readiness y campaña bilingüe protegida | `QAS/22` pruebas 1–9 + `QAS/17` completo | CORE antes de gate ON | **IMPLEMENTADA/DESPLEGADA 3/3; QAS/22 verificada** | DT-P32-03 ya desplegada; P-32 vuelve a correrse tras `QAS/23` 1–7 |
| **DT-P32-03 cierre/readiness Meta** (P-32; 04 §5.7.1; 05 §§2.6/4.5) | Cierre único por idioma en todas las rutas y comprobación estructural de `plantillaRef+idioma` antes del gate ON | Unit/integration + `QAS/23` + `QAS/17` completo | CORE bloqueante | **IMPLEMENTADA/DESPLEGADA 2/2 (`a9f4a6f`, 2026-08-15); `QAS/23` pendiente** | Gate OFF sin override; ejecutar `QAS/23` 1–7 y `QAS/17` antes de repetir P-32 |
